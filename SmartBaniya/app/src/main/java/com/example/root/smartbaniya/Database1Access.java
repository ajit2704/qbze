...
public class Database1Access {
     ...
     */
    private final String COGNITO_POOL_ID = "us-east-1:6ac1698d-59d3-416d-a28e-40ee31f83343";
     ...
     */
    private final String DYNAMODB_TABLE = "final-mobilehub-1589793418-customer";
     ...
     */
    private static volatile Database1Access instance;

    /**
     * Creates a new DatabaseAccess instance.
     * @param context the calling context
     */
    private Database1Access(Context context) {
     ...
     */
    public static synchronized Database1Access getInstance(Context context) {
        if (instance == null) {
            instance = new Database1Access(context);
        }
        return instance;
    }
    ...
    public List<Document> getAllMemos() {
        return dbTable.query(new Primitive()).getAllResults();
    }
}
